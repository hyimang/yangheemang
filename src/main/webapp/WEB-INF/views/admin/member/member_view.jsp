        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          ...
          <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <%-- ${user_id2 }--%>
                <!-- 보안코팅 적용 아래 -->
                <c:out value="${memberVO.user_id}"></c:out></p>
                <!-- jsp에서 변수(저장소)를 사용하는 방법 Model로 수신한$ user_id2 변수명로 시작 -->
                

                <hr><!-- horizontal 수평선 태그 -->
                <strong><i class="fas fa-map-marker-alt mr-1"></i>user_id </strong>
...
$(document).ready(function(){
	...
	$("#deleteBtn").bind("click", function(){
		if(confirm("정말 삭제하시겠습니까?")) {
			...
			$("#action_form").submit();
		}//confirm() 자바스크립트 함수의 반환값은 예true, 아니오false
	});
