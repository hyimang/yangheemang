    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                  	...
                  	<textarea rows="5" name="content" id="content" class="form-control">${boardVO.content}<c:out value="${boardVO.content}" /></textarea>
          ...
          <!-- 버튼영역 시작 -->
            <div class="card-body">
            	<a href="/admin/board/board_view?page=${pageVO.page}&bno=${boardVO.bno}" class="btn btn-primary float-right mr-1">뷰화면으로</a>
